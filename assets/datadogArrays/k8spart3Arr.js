export const k8spart3Arr = [
  ...
  [
    ...
    [
      "To ensure that a specified number of replicas for a pod are running at any given time",
      "t",
    ],
    ["To manage the lifecycle of a stateful application", "f"],
    ["To store sensitive information, like passwords and API keys", "f"],
  ...
  [
    ...
    ['kubectl create -f "cluster-agent-rbac.yaml"', "t"],
    ['kubectl create -f "deployment.yaml"', "f"],
    ['kubectl create -f "service.yaml"', "f"],
    ['kubectl apply -f "datadog-cluster-agent.yaml"', "f"],
  ...
  [
    'What is the purpose of the "env" section in the Datadog Cluster Agent Deployment manifest?',
    ["To set environment variables for the Cluster Agent container", "t"],
    [
      "To define volumes and volume mounts for the Cluster Agent container",
      "f",
    ],
    ["To define the API version and kind of the Kubernetes object", "f"],
    ["To define the labels for the Deployment object", "f"],
  ...
  [
    ...
    [
      "To enable communication between the node-based Agents and the Cluster Agent",
      "t",
    ],
    [
      "To disable communication between the node-based Agents and the Cluster Agent",
      "f",
    ],
    ["To specify the API key for the Datadog Cluster Agent", "f"],
    [
      "To specify the secret token for authentication between the Cluster Agent and node-based Agents",
      "f",
    ],
  ...
  [
    ...
    ["DD_CLUSTER_AGENT_SERVICE", "f"],
    ["DD_CLUSTER_AGENT_KUBERNETES_SERVICE_NAME", "t"],
    ["DD_AGENT_CLUSTER_AGENT_SERVICE", "f"],
    ["DD_AGENT_SERVICE_ENDPOINT", "f"],
  ...
  [
    ...
    ["DD_CLUSTER_AGENT_AUTH_TOKEN", "t"],
    ["DD_CLUSTER_AGENT_SECRET", "f"],
    ["DD_AGENT_AUTH_TOKEN", "f"],
    ["DD_AGENT_SECRET", "f"],
  ...
  [
    ...
    [
      "To define the volumes and volume mounts for the Cluster Agent container",
      "t",
    ],
    ["To set environment variables for the Cluster Agent container", "f"],
    ["To define the API version and kind of the Kubernetes object", "f"],
    ["To define the labels for the Deployment object", "f"],
  ...
  [
    ...
    ["To define the volumes used by the Cluster Agent container", "t"],
    ["To set environment variables for the Cluster Agent container", "f"],
    ["To define the API version and kind of the Kubernetes object", "f"],
    ["To define the labels for the Deployment object", "f"],
  ...
  [
    ...
    ["To define the labels for the Deployment object", "f"],
    ["To set environment variables for the Cluster Agent container", "f"],
    ["To match the Pods managed by the Deployment", "t"],
    ["To define the API version and kind of the Kubernetes object", "f"],
  ...
  [
    ...
    ["DD_KUBERNETES_EVENTS", "f"],
    ["DD_COLLECT_KUBERNETES_EVENTS", "t"],
    ["DD_K8S_EVENTS_COLLECTION", "f"],
    ["DD_ENABLE_K8S_EVENTS", "f"],
  ...
  [
    ...
    ["DD_KUBERNETES_STATE_METRICS", "f"],
    ["DD_COLLECT_KUBERNETES_STATE_METRICS", "f"],
    ["DD_K8S_STATE_METRICS_COLLECTION", "f"],
    ["DD_KUBERNETES_STATE", "t"],
  ...
  [
    ...
    ["To define the ports on which the Cluster Agent listens", "t"],
    ["To set environment variables for the Cluster Agent container", "f"],
    ["To define the API version and kind of the Kubernetes object", "f"],
    ["To define the labels for the Service object", "f"],
  ...
  [
    ...
    ["To allow the Cluster Agent to run on tainted nodes", "t"],
    [
      "To define the volumes and volume mounts for the Cluster Agent container",
      "f",
    ],
  ...
  [
    ...
    ["Continuously monitors containerized applications", "t"],
    ["Collects logs from your cluster", "f"],
    ["Sets up distributed tracing for your applications", "f"],
    ["Deploys kube-state-metrics", "f"],
  ...
  [
    ...
    ["An optional cluster add-on that provides cluster-level metrics", "t"],
    ["A built-in Kubernetes dashboard", "f"],
    ["A Datadog feature for automatic metric collection", "f"],
    ["A service for collecting logs", "f"],
  ...
  [
    ...
    ["Specify which Datadog check to apply to a pod", "t"],
    ["Enable Autodiscovery", "f"],
    ["Deploy kube-state-metrics", "f"],
    ["Monitor the Kubernetes control plane", "f"],
  ...
  [
    ...
    ["Sort, filter, and aggregate data based on metadata", "t"],
    ["Enable Autodiscovery", "f"],
    ["Deploy kube-state-metrics", "f"],
    ["Monitor the Kubernetes control plane", "f"],
  ...
  [
    ...
    ["Collect metrics and other telemetry data from your cluster", "t"],
    ["Enable Autodiscovery", "f"],
    ["Deploy kube-state-metrics", "f"],
    ["Monitor the Kubernetes control plane", "f"],
  ...
  [
    ...
    ["Container creation or deletion events", "t"],
    ["Kube-state-metrics deployment", "f"],
    ["New Kubernetes API server connections", "f"],
    ["Changes in the control plane", "f"],
  ...
  [
    ...
    [
      "Using a set of manifests from the official kube-state-metrics project",
      "t",
    ],
    ["Through the Datadog Agent's Autodiscovery feature", "f"],
    ["By enabling log collection in the Datadog Agent manifest", "f"],
    ["Via the Kubernetes API server", "f"],
  ...
  [
    ...
    ["Collect metrics from the cluster", "f"],
    ["Enable Autodiscovery", "f"],
    ["Monitor the Kubernetes control plane", "f"],
  ...
  [
    ...
    ["A stable IP address and DNS name", "t"],
    ["A set of replicated Pods", "f"],
    ["Configuration data to Pods", "f"],
    ["Load balancing", "f"],
